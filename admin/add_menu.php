...
if(isset($_POST['submit']))          
{
		...
		// Sanitize input values to prevent SQL errors and injection
            ...
            <div class="container-fluid">
                <!-- Start Page Content -->
                        ...
                        <div class="card card-outline-primary">
                            ...
                            <hr>
<h4 class="text-center">All Added Menus</h4>
<div class="table-responsive">
    <table class="table table-striped table-bordered">
        ...
        <tbody>
            <?php
            $sql = "SELECT dishes.*, restaurant.title as res_name 
                    FROM dishes 
            ...
            if (mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo '<td><img src="Res_img/dishes/' . $row['img'] . '" width="70" height="50"/></td>';
                    echo '<td>' . htmlspecialchars($row['res_name']) . '</td>';
                    echo '</tr>';
                }
            } else {
